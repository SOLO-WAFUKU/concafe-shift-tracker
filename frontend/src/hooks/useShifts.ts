          ...
          shifts: [
            {
              ...
              girl_id: 1,
              girl_name: 'みこち',
              girl_image_url: 'https://i.pravatar.cc/400?img=1&gender=female',
              start_time: '18:00',
              end_time: '22:00',
              shift_type: 'normal',
              notes: '',
            ...
            },
            {
              ...
              girl_id: 2,
              girl_name: 'ぺこら',
              girl_image_url: 'https://i.pravatar.cc/400?img=5&gender=female',
              start_time: '19:00',
              end_time: '23:00',
              shift_type: 'special',
              notes: '特別シフト',
          ...
          shifts: [
            {
              ...
              girl_id: 3,
              girl_name: 'あくあ',
              girl_image_url: 'https://i.pravatar.cc/400?img=9&gender=female',
              start_time: '17:00',
              end_time: '21:00',
              shift_type: 'normal',
              notes: '',
            ...
            },
            {
              ...
              girl_id: 4,
              girl_name: 'まりん',
              girl_image_url: 'https://i.pravatar.cc/400?img=12&gender=female',
              start_time: '20:00',
              end_time: '24:00',
              shift_type: 'normal',
              notes: '',
          ...
          shifts: [
            {
              ...
              girl_id: 5,
              girl_name: 'のえる',
              girl_image_url: 'https://i.pravatar.cc/400?img=16&gender=female',
              start_time: '16:00',
              end_time: '20:00',
              shift_type: 'normal',
              notes: '',
            ...
            },
            {
              ...
              girl_id: 6,
              girl_name: 'ふぶき',
              girl_image_url: 'https://i.pravatar.cc/400?img=20&gender=female',
              start_time: '21:00',
              end_time: '25:00',
              shift_type: 'special',
              notes: '深夜シフト',
  ...
  getStoreShifts: async (storeId: string, days: number = 7, startDate?: string): Promise<StoreShiftsDetail> => {
    ...
    for (let i = 0; i < days; i++) {
      ...
      allShifts.push({
        ...
        girl_id: 1,
        girl_name: 'アリス',
        girl_image_url: 'https://i.pravatar.cc/400?img=25&gender=female',
        date: dateStr,
        start_time: '18:00',
        end_time: '22:00',
        shift_type: 'normal',
    ...
    return [
      {
        ...
        girl_id: 1,
        girl_name: '検索結果',
        girl_image_url: 'https://i.pravatar.cc/400?img=30&gender=female',
        date: '2024-01-15',
        start_time: '18:00',
        end_time: '22:00',
        shift_type: 'normal',
